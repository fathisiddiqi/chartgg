...
export default function ImprovedDataTable() {
  ...
  const [creatingHeaderMode, setCreatingHeaderMode] = useState<boolean>(false);
  ...
  const handleAddColumn = () => {
    const newHeader = `Data ${headers.length + 1}`;
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <PlusCircle
                      ...
                      onClick={() => setCreatingHeaderMode(true)}
                    />
                  </DropdownMenuTrigger>
                  <DropdownMenuContent
                    align="start"
